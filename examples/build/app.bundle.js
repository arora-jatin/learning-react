...
var ValueProvider = function () {
    ...
    _createClass(ValueProvider, [{
        key: 'returnCSV',
        value: function returnCSV() {
            var msg = '';
...
var _ValueProvider = __webpack_require__(0);
...
var valueObject = new (Function.prototype.bind.apply(_ValueProvider.ValueProvider, [null].concat(args)))();
